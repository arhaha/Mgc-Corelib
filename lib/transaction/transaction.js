...
Transaction.prototype.toBufferWriter = function(writer) {
  console.log("#################### Transaction.prototype.toBufferWriter");
...
Transaction.prototype.fromBufferReader = function(reader) {
  console.log("##################### Transaction.prototype.fromBufferReader");
...
Transaction.prototype.from = function(utxo, pubkeys, threshold) {
  //console.log("################# Transaction.prototype.from ");
  if (_.isArray(utxo)) {
	//console.log("################# utxo is array ");
    var self = this;
...
Transaction.prototype._fromNonP2SH = function(utxo) {
  //console.log("################# _fromNonP2SH ");
  var clazz;
  utxo = new UnspentOutput(utxo);
  if (utxo.script.isPublicKeyHashOut()) {
    clazz = PublicKeyHashInput;
	//console.log("################# clazz is PublicKeyHashInput ");
  } else if (utxo.script.isPublicKeyOut()) {
    clazz = PublicKeyInput;
	//console.log("################# clazz is PublicKeyInput ");
  } else {
    clazz = Input;
  }
...
Transaction.prototype._fromMultisigUtxo = function(utxo, pubkeys, threshold) {
  ...
  if (utxo.script.isMultisigOut()) {
    clazz = MultiSigInput;
	//console.log("################# clazz is MultiSigInput ");
  } else if (utxo.script.isScriptHashOut()) {
    clazz = MultiSigScriptHashInput;
	//console.log("################# clazz is MultiSigScriptHashInput ");
  } else {
...
Transaction.prototype.getSignatures = function(privKey, sigtype) {
  //console.log("##################### Transaction.prototype.getSignatures");
  ...
  _.each(this.inputs, function forEachInput(input, index) {
	//console.log("##################### Transaction.prototype.getSignatures forEachInput");
